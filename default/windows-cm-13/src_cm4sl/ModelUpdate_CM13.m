...
OldVersion = 'CarMaker 12.*';
NewVersion = 'CarMaker 13.*';
...
for iFile=1:numel(FileList)
    ...
    try
	    ...
	    %%%%% Add update scripts for the models HERE %%%%%
            ...
            % VehicleControl
            update_DrivMan_demux;
            update_DrivMan_BusCreator;
            ...
            % IPG HydESP
            update_HydBrakeCtrlInCfgIF_BusCreator;
            update_HydBrakeCtrlInCfgIF_Demux;
            update_HydBrakeCtrlInIF_BusCreator(trg_mdl);
            update_HydBrakeCtrlInIF_Demux(trg_mdl);
            update_HydBrakeCtrlOutIF_BusCreator(trg_mdl);
            update_HydBrakeCtrlOutIF_Demux(trg_mdl);
